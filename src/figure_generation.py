...
def plot_sensitivity_analysis(df, filename="Figure2_Sensitivity_Analysis.png"):
    ...
    plt.title('Figure 2: PPO Agent Performance Sensitivity to Drawdown Penalty (λ)', pad=20)
...
def generate_ablation_data():
    ...
    strategies = ['PPO (Full Model)', 'PPO w/o Drawdown (λ=0)', 'PPO w/o Transaction Costs (C_t=0)']
